...
if (!empty($search)) {
    $whereConditions[] = "(name LIKE ? OR role LIKE ? OR email LIKE ?)";
    $searchParam = "%$search%";
    $params[] = $searchParam;
    $params[] = $searchParam;
    $params[] = $searchParam;
...
$query = "SELECT * FROM employees $whereClause ORDER BY name ASC LIMIT ? OFFSET ?";
    ...
    <table class="data-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo formatCurrency($row['salary']); ?></td>
